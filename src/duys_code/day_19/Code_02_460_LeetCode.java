...
/**
 * @ClassName Code_02_460_LeetCode
 * @Author Duys
 * @Description 力扣：https://leetcode-cn.com/problems/lfu-cache/
 * @Date 2021/11/3 15:29
 **/
public class Code_02_460_LeetCode {
    /**
     * LFU - 最不经常使用
     */
    ...
    static class LFUCache {
        ...
        static class Node {
            ...
            public Node up; // 节点之间是双向链表，上节点
            public Node down;// 节点之间是双向链表，下节点
        ...
        static class NodeList {
            ...
            public NodeList last;// 桶与桶之间也是双向链表
            public NodeList next;// 桶与桶之间也是双向链表
